    ...
    <div className='h-96 md:bg-gradient-to-b from-gray-200 to-gray-400 flex flex-col justify-end p-4 md:p-7 text-white'>
      <div className='flex flex-col md:flex-row items-center md:items-end'>
        ...
        <div className='md:ml-6 mt-3 md:mt-0 text-center md:text-left'>
          <span className='uppercase text-xs md:text-sm md:font-bold'>
            Username
          </span>
          <div className='text-4xl sm:text-5xl md:text-3xl lg:text-6xl xl:text-7xl font-extrabold'>
            @sjkayle
          </div>
        </div>
      </div>
...
export const WorkHero = ({ place, title }: WorkHeroProps) => {
  return (
    <div className='h-96 md:bg-gradient-to-b from-purple-light to-purple flex flex-col justify-end p-4 md:p-7 text-white'>
      ...
      <div className='text-4xl sm:text-7xl md:text-3xl lg:text-6xl xl:text-7xl font-extrabold'>
        {title}
      </div>
    </div>
  );
      ...
      >
        <div className='z-10'>
          <div className='flex items-center'>
            <Check
              className='bg-blue rounded-full p-1 mr-1 md:mr-2'
              strokeWidth={1}
              size={21}
            />
            <span className='uppercase text-xs md:text-sm md:font-semibold'>
              Front-end Developer
            </span>
          </div>
