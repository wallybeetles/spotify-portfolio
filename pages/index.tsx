            ...
            <div className="relative col-span-5 xl:col-span-4 h-96 p-5 pb-7 md:p-10 rounded-md flex flex-col justify-end overflow-hidden bg-gradient-to-t from-gray-300 to-gray-200">
              <div className="z-10">
                ...
                <div className="mt-5 mb-8 text-base md:text-lg">
                  I am a software engineer specializing in building web applications using React. Currently, I am
                  working for <span className="font-extrabold">AXA Affin Malaysia</span> under R Systems Sdn. Bhd. in
                  Kuala Lumpur.
                </div>
