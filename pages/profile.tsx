      ...
      <Body>
        ...
        <Section>
          ...
          <p className="text-base">
            ...
            in 2019 during my first job. I was given a task to create a simple static page with HTML &amp; CSS. Turns
            out, I am a person who enjoys writing code to create aesthetically pleasing user interfaces. From there, I
            found myself learning about different concepts in front-end development.
            <div className="mt-4">
