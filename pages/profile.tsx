      ...
      <Body>
        ...
        <Section>
          ...
          <p className="text-base">
            Hello! My name is Kayle and I am a self-taught front-end developer. My interest in UI development started
            back in 2019 at my first job. I was given a task to create a simple static page using only HTML &amp; CSS.
